const Hakkinda = () => {
  return (
    ...
    <section className="mt-10 p-3">
      <h2 className="text-3xl mb-5 font-semibold text-center">KodMuhasebe Hakkında</h2>
      ...
      <h3 className="text-xl font-semi-bold">KodMuhasebe Gelişim Süreci</h3>
      <p className="text-gray-700 mt-2 p-5"><b>MVP (2 Eylül 2025)</b>: Yayınlanan ilk sürüm</p>
      <p className="text-gray-700 mt-2 p-5"><b>Beta 1 (21 Eylül 2025)</b>: Tasarım iyileştirmesi, fiyat algoritması iyileştirmesi, sonuç paylaşım özelliği, PWA (Progressive Web Application)</p>
    </section>
    </>
  )
}
